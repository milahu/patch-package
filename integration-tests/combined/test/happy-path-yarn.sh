...
# FIXME
expect_error "patch-package didn't run" grep yarn node_modules/left-pad/index.js
...
expect_ok "patch-package did run" grep yarn node_modules/left-pad/index.js
